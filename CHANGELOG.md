...
- Debug mode writing to the server log and `plugins/CauldronTap/debug.log`
- `/cauldrontap reload` command to reload configuration without restarting the server
- GitHub Actions CI build workflow and changelog-driven release automation
